...
export const NODE_EDITOR_TEXT = {
    ...
    PRESET_STORAGE_WARNING: '일부 프리셋을 불러오지 못했거나 저장 형식을 완전히 이전하지 못했습니다.',
    PRESET_STORAGE_LOAD_ERROR: '저장된 프리셋을 불러오지 못했습니다.',
    PRESET_STORAGE_SAVE_ERROR: '프리셋을 저장하지 못했습니다. 브라우저 저장 공간을 확인하세요.',
    PRESET_STORAGE_DELETE_ERROR: '프리셋을 삭제하지 못했습니다. 브라우저 저장 공간을 확인하세요.',
    CIRCLE_ADD: '서클 추가',
